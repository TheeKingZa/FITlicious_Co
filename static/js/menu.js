...
const menuData = [
  ...
  { category: "Grills & Chips", item: "1/4 Chicken", description: "Chips", price: "R85.00" },
  { category: "Grills & Chips", item: "Fish", description: "Chips", price: "R60.00" },
  { category: "Grills & Chips", item: "4 x Wings", description: "Chips", price: "R70.00" },
  { category: "Grills & Chips", item: "8 x Wings", description: "Chips", price: "R140.00" },
  { category: "Grills & Chips", item: "12 x Wings", description: "Wings & Chips", price: "R180.00" },
  { category: "Grills & Chips", item: "Beef/Pork cut", description: "Chips", price: "R100.00" },
  ...
  { category: "Platters", item: "Platter 2", description: "2x Beef/Pork, 8x Wings, 4x Wors, 4x Viennas, 2x 300g Ribs, Chips", price: "R550.00" },
  { category: "Platters", item: "Platter 3", description: "3x Beef/Pork, 12x Wings, 4x Wors, 6x Viennas, 3x 300g Ribs, Chips", price: "R650.00" },

  { category: "Traditional Platters", item: "Platter 1", description: "Skopo, Mogodu, Pork Trotters, Sheep Trotters, Salad, Pap", price: "R350.00" },
  { category: "Traditional Platters", item: "Platter 2", description: "Chicken feet, Livers, Intestines, Gizzards, Salad, Pap", price: "R250.00" },

  { category: "Braai Meat", item: "Beef/Pork & Wors", description: "Pap + 2 Salads + Gravy", price: "R130.00" },
  { category: "Braai Meat", item: "1/4 Chicken", description: "Pap + 2 Salads + Gravy", price: "R80.00" },
  { category: "Braai Meat", item: "1/4 Chicken & Wors", description: "Pap + 2 Salads + Gravy", price: "R120.00" },

  { category: "Cooked Meals", item: "Skopo (half cut)", description: "Pap + 2 Salads + Gravy", price: "R150.00" },
  ...
  { category: "Chips", item: "Chips", description: "Small", price: "R30.00" },
  { category: "Chips", item: "Chips", description: "Medium", price: "R40.00" },
  { category: "Chips", item: "Chips", description: "Large", price: "R50.00" },
  ...
  { category: "Extras", item: "Gravy", description: "Tomato", price: "R10.00" },
